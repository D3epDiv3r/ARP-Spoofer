# pip3 install scapy - to install scapy
...
# sys.argv[2] simply states grab the second argument specified
# after this program name in the command line interface
...
# Add functionality to forward in script
# To forward packers so the target can have internet connection do:
